    ...
    render() {
        return (
            <>
                ...
                <div className="modal fade" id="aboutVideoModal" tabIndex="-1" aria-labelledby="aboutVideoModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                {this.state.infoItem != null ? <>
                                    <h1 className="modal-title fs-5" id="aboutVideoModalLabel">{this.state.infoItem.name}</h1>
                                </>
                                    : null
                                }
                            ...
                            <div className="modal-body">
                                {this.state.infoItem != null ? <>
                                    ...
                                    <p>Семейство: {this.state.infoItem.family}</p>
                                    <p>Поколение: {this.state.infoItem.generation}</p>
                                    <p>Серия: {this.state.infoItem.series}</p>
                            ...
                            this.state.model.map(item => {
                                return <li key={item.id} className="selectoption container">
                                    ...
                                    <div className="btnContainer">
                                        ...
                                        }} data-bs-toggle="modal" data-bs-target="#aboutVideoModal">Подробнее</button>
                                        <button className="btnChange" onClick={(ev) => {
