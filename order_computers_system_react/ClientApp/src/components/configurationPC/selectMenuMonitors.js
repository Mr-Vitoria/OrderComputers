    ...
    render() {
        return (
            <>
                ...
                <div className="modal fade" id="aboutMonitorModal" tabIndex="-1" aria-labelledby="aboutMonitorModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                {this.state.infoItem != null ? <>
                                    <h1 className="modal-title fs-5" id="aboutMonitorModalLabel">{this.state.infoItem.name}</h1>
                                </>
                                    : null
                                }
                            ...
                            this.state.model.map(item => {
                                return <li key={item.id} className="selectoption container">
                                    ...
                                    <div className="btnContainer">
                                        ...
                                        }} data-bs-toggle="modal" data-bs-target="#aboutMonitorModal">Подробнее</button>
                                        <button className="btnChange" onClick={(ev) => {
